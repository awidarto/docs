Of course. This is an excellent evolution of the command, making it a much more versatile document processing tool.

Here is the complete, revised code that incorporates the new modes, followed by the updated documentation in both English and Bahasa Indonesia.
